...
export default function Layout({ children }: any) {
  ...
  return (
    <ThemeProvider>
      <Box sx={{ display: "flex" }}>
        {/* <CssBaseline /> */}
        <div className="fixed min-w-full bg-slate-100 dark:bg-zinc-950 shadow-md dark:shadow-none z-10">
        ...
        <Drawer
          ...
          open={open}
        >
          <DrawerHeader className=" bg-slate-100 dark:bg-zinc-950 flex flex-col">
            <Image
          ...
          <List className="bg-slate-100 dark:bg-zinc-950 text-black dark:text-white flex flex-col text-xs h-screen">
            ...
            <ListItem
              className={`cursor-pointer mt-2 hover:bg-gray-200 hover:dark:bg-gray-950 transition duration-300 rounded ${
                pathname === "/"
                  ? "bg-slate-100 dark:bg-black text-black dark:text-white rounded"
                  : "dark:text-white text-black"
              }`}
